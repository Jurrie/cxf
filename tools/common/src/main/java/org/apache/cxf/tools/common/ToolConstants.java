...
public final class ToolConstants {
    ...
    public static final String CFG_MARK_GENERATED_WITHOUT_TIMESTAMP = "markGeneratedWithoutTimestamp";
    ...
    public static final String CFG_MARK_GENERATED_WITHOUT_TIMESTAMP_OPTION = "Xmark-generated-without-timestamp";
